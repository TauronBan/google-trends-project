...
func main() {
	...
	fmt.Println("Here are the main Google Search Trends for today!")
	fmt.Println("-------------------------------------------------")
	...
	for i := range r.Channel.ItemList {
		...
		fmt.Println("Link to the search trend:", r.Channel.ItemList[i].Link)
		for j := range r.Channel.ItemList[i].NewsItems {
			fmt.Println("Headline:", r.Channel.ItemList[i].NewsItems[j].Headline)
			fmt.Println("Link to article:", r.Channel.ItemList[i].NewsItems[j].HeadlineLink)
		}
		fmt.Println("-----------------------------------------------------------")
